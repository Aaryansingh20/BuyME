...
const PRODUCT_SLUG = "urban-style-coat"
const PRODUCT_NAME = "Urban Style Coat"
...
export default function UrbanStyleCoat() {
  ...
  const handleToggleWishlist = () =>
    toggleWishlist({ slug: PRODUCT_SLUG, name: PRODUCT_NAME, price: prices[selectedSize], image: urbanStyle })
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/2">
            <div className="relative bg-zinc-800 rounded-lg overflow-hidden" style={{ aspectRatio: '1 / 1' }}>
              {is3DView ? (
                <Product3DViewer modelPath="/3dmodel/hoodie.glb" />
              ) : (
                <Image
        ...
        <div className="mt-12 border-t border-zinc-800 pt-8">
          <div className="mx-auto w-full max-w-4xl space-y-4">
            ...
            <div className="h-[34rem] overflow-y-auto pr-2 text-zinc-400">
              ...
              {activeTab === 'reviews' && (
                <ProductReviews slug="urban-style-coat" onStats={(a, c) => setReviewStats({ average: a, count: c })} />
              )}
              {activeTab === 'shipping' && (
                <div className="space-y-4">
                  <div>
