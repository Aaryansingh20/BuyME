import { Package, Shield, Star, RefreshCw } from 'lucide-react'
import { Input } from "@/components/ui/input"
import { Button } from "@/components/ui/button"
import Image from "next/image"
import Link from "next/link"
import footermodel from "@/public/images/footer (2).jpg"
      ...
      <div className="container mx-auto max-w-6xl grid md:grid-cols-2 gap-12 ">
        ...
        <div className="space-y-12 flex flex-col justify-center">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-6 text-zinc-400 hover:text-white transition-colors group cursor-pointer">
              <Package className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
              <div>
                <div className="text-sm uppercase">Delivery</div>
                <div className="text-base">Global shipping</div>
              </div>
            </div>
            <div className="flex items-center gap-6 text-zinc-400 hover:text-white transition-colors group cursor-pointer">
              <Shield className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
              <div>
                <div className="text-sm uppercase">Quality</div>
                <div className="text-base">Our product</div>
              </div>
            </div>
            <div className="flex items-center gap-6 text-zinc-400 hover:text-white transition-colors group cursor-pointer">
              <Star className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
              <div>
                <div className="text-sm uppercase">Reviews</div>
                <div className="text-base">Customer information</div>
              </div>
            </div>
            <div className="flex items-center gap-6 text-zinc-400 hover:text-white transition-colors group cursor-pointer">
              <RefreshCw className="w-6 h-6 group-hover:text-blue-500 transition-colors" />
              <div>
                <div className="text-sm uppercase">Returning</div>
                <div className="text-base">Cash back policy</div>
              </div>
            </div>
          </div>
        </div>
